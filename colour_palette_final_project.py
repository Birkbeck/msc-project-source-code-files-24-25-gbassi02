...
#raw_data= pd.DataFrame(palettes[:5], columns=[f"colour_{i+1}" for i in range(5)],  index=[f"palette_{j+1}" for j in range(5)]) #used during development
#print(raw_data)
